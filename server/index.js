    ...
    const transcribeUrl = async (audioFilePath) => {
     ...
     console.log("this is result",result)
      ...
      console.log("this is transcript",transcript)
        // Extract detailed sentences
        // const sentences = result.results.channels[0].alternatives[0].paragraphs.sentences;
        // console.log("this is sentence",sentences,"this is type",typeof sentences)
        ...
        // // Optionally, save the transcription and detailed sentences to files
        // fs.writeFileSync('transcription.txt', transcript);
        // fs.writeFileSync('sentences.json', JSON.stringify(formattedSentences, null, 2));
     return transcript
